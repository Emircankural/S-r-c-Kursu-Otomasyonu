...
CREATE TABLE `admin` (
  ...
  CONSTRAINT `admin_ibfk_1` FOREIGN KEY (`ogretmen_TC`) REFERENCES `ogretmen` (`ogretmen_TC`),
  CONSTRAINT `admin_ibfk_2` FOREIGN KEY (`ogrenci_TC`) REFERENCES `ogrenci` (`ogrenci_TC`)
...
INSERT INTO `admin` VALUES (1,'admin',NULL,NULL),(2,'admin',NULL,NULL);
